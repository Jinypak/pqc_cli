...
PyKCS11 이 이미 로드/초기화한 cryptoki.dll 과 동일 모듈을 WinDLL 로 다시 열어
...
from ctypes import (
    POINTER, Structure, WinDLL, addressof, byref, c_char_p, c_ubyte,
...
# ── PKCS#11 기본 타입 (Windows: CK_ULONG = 32bit) ────────────────
CK_ULONG = c_ulong
CK_RV = CK_ULONG
HOBJ = CK_ULONG
